    ...
    <SectionContainer>
      <div className="bg-[#26875C] text-white p-6 my-8 sm:my-16 rounded-2xl relative overflow-hidden h-64 md:h-64 flex items-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-4/5 mx-auto">
          <h2 className="mb-6 md:mb-0 text-3xl sm:text-[40px] font-medium z-10 lg:max-w-md md:max-w-sm md:text-left text-center">
          ...
          <button
            ...
            className="bg-white text-black font-medium py-3 px-6 text-sm sm:py-4 sm:px-8 shadow-md z-10 cursor-pointer"
          >
            Start Free
          </button>
        </div>
